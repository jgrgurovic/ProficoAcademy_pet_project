        ...
        <li  className="ml-12 flex justify-center items-center font-courier-prime text-xl text-white">
          ...
          <form className="form-inline flex ">
           <input className="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
            ...
            <button className=" border border-red-600 text-red-600 py-2 px-4 rounded-lg transition-colors hover:bg-red-600 hover:text-white" type="submit">Search</button>
           </form>
      <div >
