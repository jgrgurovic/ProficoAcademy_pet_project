...
<div className="max-w-md mx-auto p-4">
  <form>
    <div className="mb-4">
      {/* <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="caseName">
        Case Name
      </label> */}
      <input
        type="text"
    ...
    <div className="mb-4">
      {/* <label className="block text-gray-700 text-sm font-bold mb-2" htmlFor="caseDescription">
        Case Description
      </label> */}
      <input
        type="text"
